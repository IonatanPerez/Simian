localfolder = "./Selenium/raw/autores/" # Carpeta donde se almacena la info que se va generando. Esta carpeta esta en el gitignore
scrappingFile = localfolder + "scrappingLog.json" # Archivo donde se guarda info del scrapping
nroAutoresLimiteNulos = 10 # Asumimos que cuando hay 10 ids consecutivos sin info es que se acabo la lista de autores. 
